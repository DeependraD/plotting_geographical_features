...
## Plotting districtwise maize area profile
...
maize_area_1516 <- ggplot() +
  ...
  xlab(NULL) + ylab(NULL) +
  theme_bw() + 
  ggtitle("Estimated districtwise area under maize grain in Nepal, featuring top 10 districts during\nYear: 2015/16\n(Source: Statistical Year Book, 2017)") +
...
ggsave("./outputs/npl_top_maize_growing_districts_areawise.png", 
       plot = maize_area_1516, units = "in", dpi = 300, width = 12, height = 8)
