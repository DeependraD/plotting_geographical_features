...
## Plotting districtwise maize production profile
dist_wise_maize <- readxl::read_xlsx("./data/npl_maize_districts_0506-1516.xlsx", sheet = "production", skip = 1)
...
maize_production_1516 <- ggplot() +
  ...
  xlab(NULL) + ylab(NULL) +
  theme_bw() + 
  ggtitle("Estimated districtwise production of maize grain in Nepal, featuring top 10 districts during\nYear: 2015/16\n(Source: Statistical Year Book, 2017)") +
...
# maize_production_1516

ggsave("./outputs/npl_top_maize_growing_districts_productionwise.png", 
       plot = maize_production_1516, units = "in", dpi = 300, width = 12, height = 8)
